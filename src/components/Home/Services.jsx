...
const servicesData = [
  {
    ...
    icon: <img src={penToolIcon} alt="Briefcase Icon" className="w-12 h-12" />,
  },
  {
  ...
  },
  {
    ...
    icon: <img src={briefcaseIcon} alt="Pen Tool Icon" className="w-12 h-12" />,
  },
  {
    ...
    <>
      <div className="flex flex-col items-center justify-center py-12">
        <div className="max-w-6xl mx-auto py-12 px-6 space-y-36">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:my-10 ">
            <p
              className="text-6xl font-bold text-right"
            >
              <span className="text-yellow-400">hello</span>.
            </p>
            <p className="text-3xl text-right font-bold pe-12">
              Award winning <br /> agency specializing <br /> in creative design
            </p>
            <div className="flex flex-col">
              ...
              <a
                ...
                className="text-black underline text-xl font-semibold mt-5"
              >
        ...
        <hr className="border-1 border-black my-12 w-full P-0" />
      </div>
    </>
  );
};
